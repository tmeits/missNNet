---
title: "wmo 23274 igarka station: Missing Data"
author: IVA
...
file.name <- "/23274-igarka.txt"

igarka.cli <- read.csv(paste0(file.cli.path,file.name), header = FALSE, sep = ";", dec = ".") 
igarka.cli <- igarka.cli[-c(5, 7, 9, 11, 13, 14)]  # we delete excess columns
igarka.cli <- setNames(igarka.cli, c("Station", "Year", "Month", "Day", "TMIN", "TMEAN", "TMAX", "PRECIP")) # Assign columns names
df.cli.site <- igarka.cli
str(df.cli.site)
summary(df.cli.site)
...
grnn.prec.1955 <- grnn.prec(1955, 3, 2.6)
#plot(grnn.prec.1978)
grnn.prec.1956 <- grnn.prec(1956, 5, 1.6)
#plot(grnn.prec.1939)
grnn.prec.1957 <- grnn.prec(1957, 2, 1.2)
#plot(grnn.prec.1979)
...
grnn.temp.1955 <- grnn.temp(1955, 1.3 ,2.3)
#plot(grnn.temp.1939)
grnn.temp.1956 <- grnn.temp(1956, 1.5 ,2.0)
#plot(grnn.temp.1978)
grnn.temp.1957 <- grnn.temp(1957, 1.2 ,2.2)
#plot(grnn.temp.1979)
...
df.cli.site.period[df.cli.site.period$Year==1955, 8] <- grnn.prec.1955
df.cli.site.period[df.cli.site.period$Year==1956, 8] <- grnn.prec.1956
df.cli.site.period[df.cli.site.period$Year==1957, 8] <- grnn.prec.1957

df.cli.site.period[df.cli.site.period$Year==1955, 6] <- grnn.temp.1955
df.cli.site.period[df.cli.site.period$Year==1956, 6] <- grnn.temp.1956
df.cli.site.period[df.cli.site.period$Year==1957, 6] <- grnn.temp.1957
...
for (i in min(df.cli.site.period$Year):max(df.cli.site.period$Year)){
  ...
  summary(df.vso.i)
  write.table.vso(df.vso.i, file.cli.path, paste0("/23274-igarka.cli/", i, ".CLI"))
}
