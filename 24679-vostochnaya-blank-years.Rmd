---
title: "24679-vostochnaya.txt aisori station: Missing Data"
author: IVA
...
file.name <- "/24679-vostochnaya.txt"
...
for (i in min(df.cli.site.period$Year):max(df.cli.site.period$Year)){
  ...
  summary(df.vso.i)
  write.table.vso(df.vso.i, file.cli.path, paste0("/24679-vostochnaya.cli/", i, ".CLI"))
}
